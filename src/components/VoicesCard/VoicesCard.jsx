        ...
        <Empty
          image={
            <svg
              ...
              version="1.0"
              viewBox="0 0 100 100"
              className={`${styles.empty__color} ${
                themeList ? styles.empty__dark : ""
              }`}
            >
              <path
                d="M16.2 15.7c-.5 1-3.5 9.5-6.6 18.9L3.9 51.7l.3 15.9.3 15.9h91l.2-16.5.2-16.5-6.2-18-6.2-18-33.2-.3c-30.9-.2-33.3-.1-34.1 1.5zm69.2 17c2.7 8.2 5.1 15.3 5.3 16 .4.9-3.1 1.3-13.8 1.5l-14.3.3-.9 3.6c-.5 2-2.2 5-3.8 6.5-2.5 2.4-3.9 2.9-7.9 2.9s-5.4-.5-7.9-2.9c-1.6-1.5-3.3-4.5-3.8-6.5l-.9-3.6-14.3-.3c-10.7-.2-14.2-.6-13.8-1.5.2-.7 2.6-7.8 5.3-16L19.4 18h61.2l4.8 14.7z"
                fill="currentColor"
              />
            </svg>
          }
          description={
            <span
              className={`${styles.no__data} ${
                themeList ? styles.data_dark : ""
              }`}
            >
              {lang === "ru" ? "Информация не найдена" : "Ma'lumot topilmadi"}
            </span>
          }
        />
      )}
